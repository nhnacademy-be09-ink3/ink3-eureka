...
import com.nhnacademy.miniproject.domain.member.exception.LoginCountOverException;
...
public class CustomAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    public CustomAuthenticationFailureHandler(LoginFailureCounterService loginFailureCounterService, RedisTemplate<String, Object> sessionRedisTemplate, MessageSendService messageSendService) {
